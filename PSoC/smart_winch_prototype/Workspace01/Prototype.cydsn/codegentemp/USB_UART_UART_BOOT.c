...
/*******************************************************************************
* Function Name: USB_UART_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: USB_UART_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: USB_UART_UartCyBtldrCommReset
****************************************************************************//**
*
...
void USB_UART_UartCyBtldrCommReset(void)
{
    ...
    USB_UART_SpiUartClearRxBuffer();
    USB_UART_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: USB_UART_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != USB_UART_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = USB_UART_SpiUartGetRxBufferSize();
                    CyDelayUs(USB_UART_UART_BYTE_TO_BYTE);
                }
                while (byteCount != USB_UART_SpiUartGetRxBufferSize());

                byteCount = USB_UART_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) USB_UART_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: USB_UART_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus USB_UART_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        USB_UART_SpiUartPutArray(pData, (uint32) size);
