...
#define USB_UART_UART_OVS_FACTOR            (16u)
#define USB_UART_UART_IRDA_LOW_POWER        (0u)
#define USB_UART_UART_MEDIAN_FILTER_ENABLE  (1u)
...
#define USB_UART_UART_RX_BUFFER_SIZE        (32u)
#define USB_UART_UART_TX_BUFFER_SIZE        (32u)
...
#define USB_UART_UART_INTERRUPT_MODE        (1u)

#define USB_UART_UART_INTR_RX_MASK          (0x4u)
