// ======================================================================
// Prototype.v generated from TopDesign.cysch
// 12/25/2017 at 11:23
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=60000, TCPrescaler=6, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PID_Tick_Timer, CY_INSTANCE_SHORT_NAME=PID_Tick_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=PID_Tick_Timer, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0\xor_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0\xor_v1_0.v"
`endif
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=50, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=100, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Millis_TMR, CY_INSTANCE_SHORT_NAME=Millis_TMR, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Millis_TMR, )
...
module ADC_SAR_SEQ_P4_v2_50_5 (
	...
	cy_clock_v1_0
		#(.id("f02079b6-d6c3-41d3-8906-646b3b21a89a/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
...
module top ;
    ...
    TCPWM_P4_v2_10_2 PID_Tick_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("38d49943-e0d5-43cf-9b2c-2d15d0c9433e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Bridge_1_net;
	wire [0:0] tmpFB_0__Bridge_1_net;
	wire [0:0] tmpIO_0__Bridge_1_net;
	wire [0:0] tmpINTERRUPT_0__Bridge_1_net;
	electrical [0:0] tmpSIOVREF__Bridge_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Bridge_1
		 (.oe(tmpOE__Bridge_1_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__Bridge_1_net[0:0]}),
		  .io({tmpIO_0__Bridge_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Bridge_1_net),
		  .interrupt({tmpINTERRUPT_0__Bridge_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bridge_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bridge_2_net;
	wire [0:0] tmpFB_0__Bridge_2_net;
	wire [0:0] tmpIO_0__Bridge_2_net;
	wire [0:0] tmpINTERRUPT_0__Bridge_2_net;
	electrical [0:0] tmpSIOVREF__Bridge_2_net;

	cy_psoc3_pins_v1_10
		#(.id("5d1873de-af71-4376-8087-7e432dc84697"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Bridge_2
		 (.oe(tmpOE__Bridge_2_net),
		  .y({Net_41}),
		  .fb({tmpFB_0__Bridge_2_net[0:0]}),
		  .io({tmpIO_0__Bridge_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Bridge_2_net),
		  .interrupt({tmpINTERRUPT_0__Bridge_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bridge_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_30 = Net_40 ^ Net_41;
	...
	wire [0:0] tmpOE__QE_A_net;
	wire [0:0] tmpIO_0__QE_A_net;
	wire [0:0] tmpINTERRUPT_0__QE_A_net;
	electrical [0:0] tmpSIOVREF__QE_A_net;
	...
	cy_psoc3_pins_v1_10
		...
		QE_A
		 (.oe(tmpOE__QE_A_net),
		  .y({1'b0}),
		  .fb({Net_386}),
		  .io({tmpIO_0__QE_A_net[0:0]}),
		  .siovref(tmpSIOVREF__QE_A_net),
		  .interrupt({tmpINTERRUPT_0__QE_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QE_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__QE_B_net;
	wire [0:0] tmpIO_0__QE_B_net;
	wire [0:0] tmpINTERRUPT_0__QE_B_net;
	electrical [0:0] tmpSIOVREF__QE_B_net;

	cy_psoc3_pins_v1_10
		#(.id("f72fe91c-70a6-44c2-aca9-2f466a27819d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		QE_B
		 (.oe(tmpOE__QE_B_net),
		  .y({1'b0}),
		  .fb({Net_3}),
		  .io({tmpIO_0__QE_B_net[0:0]}),
		  .siovref(tmpSIOVREF__QE_B_net),
		  .interrupt({tmpINTERRUPT_0__QE_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QE_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("f4d283f7-35ff-42f3-bbcc-0a7bfae77b48"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("53045759-a1a2-4a9c-83dc-ed00e1c02992"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    // -- DFF Start --
    reg  cydff_2;
    always @(posedge Net_3)
    begin
        cydff_2 <= Net_386;
    end
    assign Net_393 = cydff_2;
    // -- DFF End --

	wire [0:0] tmpOE__Direction_Flag_net;
	wire [0:0] tmpFB_0__Direction_Flag_net;
	wire [0:0] tmpIO_0__Direction_Flag_net;
	wire [0:0] tmpINTERRUPT_0__Direction_Flag_net;
	electrical [0:0] tmpSIOVREF__Direction_Flag_net;

	cy_psoc3_pins_v1_10
		#(.id("59b7cb84-29e7-4c61-9dc8-32e7c2189dc8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Direction_Flag
		 (.oe(tmpOE__Direction_Flag_net),
		  .y({Net_393}),
		  .fb({tmpFB_0__Direction_Flag_net[0:0]}),
		  .io({tmpIO_0__Direction_Flag_net[0:0]}),
		  .siovref(tmpSIOVREF__Direction_Flag_net),
		  .interrupt({tmpINTERRUPT_0__Direction_Flag_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Direction_Flag_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Current_B_net;
	wire [0:0] tmpFB_0__Current_B_net;
	wire [0:0] tmpIO_0__Current_B_net;
	wire [0:0] tmpINTERRUPT_0__Current_B_net;
	electrical [0:0] tmpSIOVREF__Current_B_net;

	cy_psoc3_pins_v1_10
		#(.id("bd06175d-2923-4662-b2f1-92b67b18aeef"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Current_B
		 (.oe(tmpOE__Current_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Current_B_net[0:0]}),
		  .analog({Net_433}),
		  .io({tmpIO_0__Current_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Current_B_net),
		  .interrupt({tmpINTERRUPT_0__Current_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Current_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Current_A_net;
	wire [0:0] tmpFB_0__Current_A_net;
	wire [0:0] tmpIO_0__Current_A_net;
	wire [0:0] tmpINTERRUPT_0__Current_A_net;
	electrical [0:0] tmpSIOVREF__Current_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Current_A
		 (.oe(tmpOE__Current_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Current_A_net[0:0]}),
		  .analog({Net_434}),
		  .io({tmpIO_0__Current_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Current_A_net),
		  .interrupt({tmpINTERRUPT_0__Current_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Current_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("92a3cc03-a3e3-4a07-a7a6-36b272a7903f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a9427a8-6dd2-49d1-8c3a-4e871b0bd070"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__NRF_IRQ_net;
	wire [0:0] tmpFB_0__NRF_IRQ_net;
	wire [0:0] tmpIO_0__NRF_IRQ_net;
	electrical [0:0] tmpSIOVREF__NRF_IRQ_net;

	cy_psoc3_pins_v1_10
		#(.id("7ca236cb-5367-461c-ac0e-1fd9f890105a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NRF_IRQ
		 (.oe(tmpOE__NRF_IRQ_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF_IRQ_net[0:0]}),
		  .io({tmpIO_0__NRF_IRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF_IRQ_net),
		  .interrupt({Net_465}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__NRF_IRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
