...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL4, 0x0001DF00u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00001900u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_CMD, 0x8000FF43u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL1, 0x00000500u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL14), 0x00000040u);
	...
	CY_SET_REG32((void *)(CYREG_WDT_CONFIG), 0x00000006u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x30000000u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00000033u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x15000000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00060000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00020060u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00C00000u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000003u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00180036u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000003u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x00000003u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000003u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00000D92u);

	/* IOPINS0_4 Starting address: CYDEV_GPIO_PRT4_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x0000000Du);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x0000ED8Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_INTR_CFG), 0x00000800u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT6_PC), 0x00010000u);
