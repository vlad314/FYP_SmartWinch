// ======================================================================
// UART_over_nFR24.v generated from TopDesign.cysch
// 03/19/2018 at 15:26
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("09b0a025-e2b7-4016-9fbe-42685cad1061"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("25cb6faf-dd9b-46f2-9237-b30f6391de2f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("38c5649f-4b5b-4526-a8ff-5c59d99e1edb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MASTER_UNIT_net;
	wire [0:0] tmpFB_0__MASTER_UNIT_net;
	wire [0:0] tmpIO_0__MASTER_UNIT_net;
	wire [0:0] tmpINTERRUPT_0__MASTER_UNIT_net;
	electrical [0:0] tmpSIOVREF__MASTER_UNIT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		MASTER_UNIT
		 (.oe(tmpOE__MASTER_UNIT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MASTER_UNIT_net[0:0]}),
		  .io({tmpIO_0__MASTER_UNIT_net[0:0]}),
		  .siovref(tmpSIOVREF__MASTER_UNIT_net),
		  .interrupt({tmpINTERRUPT_0__MASTER_UNIT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MASTER_UNIT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NRF_ISR_net;
	wire [0:0] tmpFB_0__NRF_ISR_net;
	wire [0:0] tmpIO_0__NRF_ISR_net;
	wire [0:0] tmpINTERRUPT_0__NRF_ISR_net;
	electrical [0:0] tmpSIOVREF__NRF_ISR_net;

	cy_psoc3_pins_v1_10
		#(.id("e96ca119-6285-42f6-b970-7095d1e0b6b8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NRF_ISR
		 (.oe(tmpOE__NRF_ISR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF_ISR_net[0:0]}),
		  .io({tmpIO_0__NRF_ISR_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF_ISR_net),
		  .interrupt({tmpINTERRUPT_0__NRF_ISR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF_ISR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3c4e6ebb-6b57-405f-a8b3-e41677f65714"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
