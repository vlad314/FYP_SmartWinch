    ...
    *******************************************************************************/
    void USB_UART_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        else if (USB_UART_SCB_MODE_SPI == mode)
        {
            ...
            hsiomSel[USB_UART_CTS_SCLK_PIN_INDEX] = USB_UART_CTS_SCLK_HSIOM_SEL_SPI;
            ...
            if (USB_UART_SPI_SLAVE == subMode)
            {
                ...
                pinsDm[USB_UART_CTS_SCLK_PIN_INDEX] = USB_UART_PIN_DM_DIG_HIZ;

            #if (USB_UART_RTS_SS0_PIN)
                /* Only SS0 is valid choice for Slave */
                hsiomSel[USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_RTS_SS0_HSIOM_SEL_SPI;
                pinsDm  [USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_PIN_DM_DIG_HIZ;
            ...
            else 
            {
                ...
                pinsDm[USB_UART_CTS_SCLK_PIN_INDEX] = USB_UART_PIN_DM_STRONG;

            #if (USB_UART_RTS_SS0_PIN)
                hsiomSel [USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_RTS_SS0_HSIOM_SEL_SPI;
                pinsDm   [USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_PIN_DM_STRONG;
                pinsInBuf |= USB_UART_RTS_SS0_PIN_MASK;
            #endif /* (USB_UART_RTS_SS0_PIN) */
            ...
            #if (USB_UART_CTS_SCLK_PIN)
                pinsInBuf |= USB_UART_CTS_SCLK_PIN_MASK;
            #endif /* (USB_UART_CTS_SCLK_PIN) */
            }
        }
        else /* UART */
        {
            ...
            else /* Standard or IrDA */
            {
                ...
                if (USB_UART_UART_MODE_STD == subMode)
                {
                    ...
                    #if (USB_UART_CTS_SCLK_PIN)
                        hsiomSel[USB_UART_CTS_SCLK_PIN_INDEX] = USB_UART_CTS_SCLK_HSIOM_SEL_UART;
                        pinsDm  [USB_UART_CTS_SCLK_PIN_INDEX] = USB_UART_PIN_DM_DIG_HIZ;
                    #endif /* (USB_UART_CTS_SCLK_PIN) */
                    }
                    ...
                    #if (USB_UART_RTS_SS0_PIN)
                        hsiomSel[USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_RTS_SS0_HSIOM_SEL_UART;
                        pinsDm  [USB_UART_RTS_SS0_PIN_INDEX] = USB_UART_PIN_DM_STRONG;
    ...
    #if (USB_UART_CTS_SCLK_PIN)
        USB_UART_SET_HSIOM_SEL(USB_UART_CTS_SCLK_HSIOM_REG,
                                       USB_UART_CTS_SCLK_HSIOM_MASK,
                                       USB_UART_CTS_SCLK_HSIOM_POS,
                                       hsiomSel[USB_UART_CTS_SCLK_PIN_INDEX]);

        USB_UART_uart_cts_spi_sclk_SetDriveMode((uint8) pinsDm[USB_UART_CTS_SCLK_PIN_INDEX]);

        USB_UART_SET_INP_DIS(USB_UART_uart_cts_spi_sclk_INP_DIS,
                                     USB_UART_uart_cts_spi_sclk_MASK,
                                     (0u != (pinsInBuf & USB_UART_CTS_SCLK_PIN_MASK)));
    #endif /* (USB_UART_CTS_SCLK_PIN) */

    #if (USB_UART_RTS_SS0_PIN)
        USB_UART_SET_HSIOM_SEL(USB_UART_RTS_SS0_HSIOM_REG,
                                       USB_UART_RTS_SS0_HSIOM_MASK,
                                       USB_UART_RTS_SS0_HSIOM_POS,
                                       hsiomSel[USB_UART_RTS_SS0_PIN_INDEX]);

        USB_UART_uart_rts_spi_ss0_SetDriveMode((uint8) pinsDm[USB_UART_RTS_SS0_PIN_INDEX]);

        USB_UART_SET_INP_DIS(USB_UART_uart_rts_spi_ss0_INP_DIS,
                                     USB_UART_uart_rts_spi_ss0_MASK,
                                     (0u != (pinsInBuf & USB_UART_RTS_SS0_PIN_MASK)));
    #endif /* (USB_UART_RTS_SS0_PIN) */
