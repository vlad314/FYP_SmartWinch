...
#define USB_UART_REMOVE_CTS_SCLK_PIN      (1u)
#define USB_UART_REMOVE_RTS_SS0_PIN      (1u)
...
#define USB_UART_CTS_SCLK_PIN     (0u == USB_UART_REMOVE_CTS_SCLK_PIN)
#define USB_UART_RTS_SS0_PIN     (0u == USB_UART_REMOVE_RTS_SS0_PIN)
...
#if (USB_UART_CTS_SCLK_PIN)
    #include "USB_UART_uart_cts_spi_sclk.h"
#endif /* (USB_UART_CTS_SCLK) */

#if (USB_UART_RTS_SS0_PIN)
    #include "USB_UART_uart_rts_spi_ss0.h"
...
#if (USB_UART_CTS_SCLK_PIN)
    #define USB_UART_CTS_SCLK_HSIOM_REG   (*(reg32 *) USB_UART_uart_cts_spi_sclk__0__HSIOM)
    #define USB_UART_CTS_SCLK_HSIOM_PTR   ( (reg32 *) USB_UART_uart_cts_spi_sclk__0__HSIOM)
    
    #define USB_UART_CTS_SCLK_HSIOM_MASK      (USB_UART_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define USB_UART_CTS_SCLK_HSIOM_POS       (USB_UART_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define USB_UART_CTS_SCLK_HSIOM_SEL_GPIO  (USB_UART_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define USB_UART_CTS_SCLK_HSIOM_SEL_I2C   (USB_UART_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define USB_UART_CTS_SCLK_HSIOM_SEL_SPI   (USB_UART_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define USB_UART_CTS_SCLK_HSIOM_SEL_UART  (USB_UART_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (USB_UART_CTS_SCLK_PIN) */

#if (USB_UART_RTS_SS0_PIN)
    #define USB_UART_RTS_SS0_HSIOM_REG   (*(reg32 *) USB_UART_uart_rts_spi_ss0__0__HSIOM)
    #define USB_UART_RTS_SS0_HSIOM_PTR   ( (reg32 *) USB_UART_uart_rts_spi_ss0__0__HSIOM)
    
    #define USB_UART_RTS_SS0_HSIOM_MASK      (USB_UART_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define USB_UART_RTS_SS0_HSIOM_POS       (USB_UART_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define USB_UART_RTS_SS0_HSIOM_SEL_GPIO  (USB_UART_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define USB_UART_RTS_SS0_HSIOM_SEL_I2C   (USB_UART_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define USB_UART_RTS_SS0_HSIOM_SEL_SPI   (USB_UART_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(USB_UART_CY_SCBIP_V0 || USB_UART_CY_SCBIP_V1)
    #define USB_UART_RTS_SS0_HSIOM_SEL_UART  (USB_UART_uart_rts_spi_ss0__0__HSIOM_UART)
...
#define USB_UART_CTS_SCLK_PIN_INDEX       (2u)
#define USB_UART_RTS_SS0_PIN_INDEX       (3u)
...
#define USB_UART_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << USB_UART_CTS_SCLK_PIN_INDEX)
#define USB_UART_RTS_SS0_PIN_MASK     ((uint32) 0x01u << USB_UART_RTS_SS0_PIN_INDEX)
...
#if (USB_UART_RTS_SS0_PIN)
    #define USB_UART_CHECK_RTS_SS0_PIN_USED \
                (USB_UART_PIN_DM_ALG_HIZ != \
                    USB_UART_GET_P4_PIN_DM(USB_UART_uart_rts_spi_ss0_PC, \
                                                   USB_UART_uart_rts_spi_ss0_SHIFT))
#endif /* (USB_UART_RTS_SS0_PIN) */
...
#define USB_UART_REMOVE_SCLK_PIN                USB_UART_REMOVE_CTS_SCLK_PIN
#endif /* USB_UART_REMOVE_SCLK_PIN */
#ifndef USB_UART_REMOVE_SS0_PIN
#define USB_UART_REMOVE_SS0_PIN                 USB_UART_REMOVE_RTS_SS0_PIN
...
#define USB_UART_SCLK_PIN               USB_UART_CTS_SCLK_PIN
#endif /* USB_UART_SCLK_PIN */
#ifndef USB_UART_SS0_PIN
#define USB_UART_SS0_PIN                USB_UART_RTS_SS0_PIN
    ...
    #define USB_UART_SCLK_HSIOM_REG     USB_UART_CTS_SCLK_HSIOM_REG
    #define USB_UART_SCLK_HSIOM_PTR     USB_UART_CTS_SCLK_HSIOM_PTR
    #define USB_UART_SCLK_HSIOM_MASK    USB_UART_CTS_SCLK_HSIOM_MASK
    #define USB_UART_SCLK_HSIOM_POS     USB_UART_CTS_SCLK_HSIOM_POS
    #endif /* USB_UART_SCLK_HSIOM_REG */
#endif /* (USB_UART_SCLK_PIN) */

#if (USB_UART_SS0_PIN)
    #ifndef USB_UART_SS0_HSIOM_REG
    #define USB_UART_SS0_HSIOM_REG      USB_UART_RTS_SS0_HSIOM_REG
    #define USB_UART_SS0_HSIOM_PTR      USB_UART_RTS_SS0_HSIOM_PTR
    #define USB_UART_SS0_HSIOM_MASK     USB_UART_RTS_SS0_HSIOM_MASK
    #define USB_UART_SS0_HSIOM_POS      USB_UART_RTS_SS0_HSIOM_POS
...
#define USB_UART_SCLK_PIN_INDEX             USB_UART_CTS_SCLK_PIN_INDEX
#endif /* USB_UART_SCLK_PIN_INDEX */
#ifndef USB_UART_SS0_PIN_INDEX
#define USB_UART_SS0_PIN_INDEX              USB_UART_RTS_SS0_PIN_INDEX
...
#define USB_UART_SCLK_PIN_MASK             USB_UART_CTS_SCLK_PIN_MASK
#endif /* USB_UART_SCLK_PIN_MASK */
#ifndef USB_UART_SS0_PIN_MASK
#define USB_UART_SS0_PIN_MASK              USB_UART_RTS_SS0_PIN_MASK
