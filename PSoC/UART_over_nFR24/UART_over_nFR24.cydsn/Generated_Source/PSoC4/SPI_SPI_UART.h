...
#define SPI_SPI_MEDIAN_FILTER_ENABLE   (1u)
...
#define SPI_SPI_RX_BUFFER_SIZE         (64u)
#define SPI_SPI_TX_BUFFER_SIZE         (64u)

#define SPI_SPI_INTERRUPT_MODE         (1u)

#define SPI_SPI_INTR_RX_MASK           (0x4u)
